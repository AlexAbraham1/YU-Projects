...
var simpleHTML = function (title, text1, text2) {

  return '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><html lang="en">' +
    '<head>' +
    ...
    '             <br><h2 style="color: #34495e; font-weight: bold; line-height: 120%; text-align: center; font-size: 130%;" align="center">' +
    title +
    '</h2>' +
    '<div style="color: #34495e; font-weight: bold; line-height: 120%; text-align: center; font-size: 130%;" align="center">' +
    text1 +
    '</div>' +
    '<br><br>' +
...
exports.signupHTML = simpleHTML("Thank you for Signing up!",
    'We will notify you when there are further details about the semester-long project!',
    'For now, think of a cool project idea to submit!'
  );

exports.newProjectHTML = simpleHTML("New project has been added",
"Someone has posted a project", "As an admin, go and check it out!");
